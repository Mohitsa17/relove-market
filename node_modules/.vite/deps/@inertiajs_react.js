...
function Ae2(r4 = {}) {
  let e = typeof window > "u" ? null : Qr.getCached(window.location.pathname, r4), i = typeof window > "u" ? null : Qr.getPrefetching(window.location.pathname, r4), [s, a] = (0, import_react12.useState)((e == null ? void 0 : e.staleTimestamp) || null), [f2, d] = (0, import_react12.useState)(i !== null), [P2, c] = (0, import_react12.useState)(e !== null);
  ...
  return (0, import_react13.useEffect)(() => {
    ...
    let t = new IntersectionObserver((g2) => {
      ...
      Qr.reload({ ...F2, onStart: (b) => {
        var _a;
        l2.current = true, (_a = F2.onStart) == null ? void 0 : _a.call(F2, b);
      }, onFinish: (b) => {
        var _a;
        c(true), l2.current = false, (_a = F2.onFinish) == null ? void 0 : _a.call(F2, b), f2 || t.disconnect();
      } });
    }, { rootMargin: `${s || 0}px` });
